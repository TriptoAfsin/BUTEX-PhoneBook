let database = [
   {
     ...
     },
     {
      "name": "Md. Nurul Islam Miah",
       ...
       "faculty" : "Faculty of Science & Engineering, Electrical Lab(Technical Officer)",
      "terms": "eee lab" ,
     },
     {
      "name": "Mohammad Alauddin",
       "contact": "+8801731488206",
       "faculty" : "Faculty of Science & Engineering, Computer Lab(Technical Officer)",
      "terms": "lab" ,
     },
     {
     ...
     },
     {
      "name": "Dilara Hossain",
       ...
       "faculty" : "Faculty of Textile Management & Business Studies(Humanities & Social Science)",
      "terms": "DH HSS" ,
     },
     {
...
const searchBooks = async searchText =>{
    ...
    let matches = books.filter(book =>{
        ...
        return book.name.match(regex) || book.faculty.match(regex) || book.terms.match(regex) || book.contact.match(regex);
    });
